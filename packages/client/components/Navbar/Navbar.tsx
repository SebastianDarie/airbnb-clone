    ...
    <header className='Navbar__header'>
      <div className='Navbar__container'>
        ...
        <div className='Navbar__links'>
          <div className='Navbar__searchbar__small'>
            <div className='Navbar__search__small' role='search'>
              <button className='Navbar__search__small__btn' type='button'>
                <div className='Navbar__search__small__text'>
                  Start your search
                </div>
                <div className='Navbar__search__small__icon' data-icon='true'>
                  <svg
                    viewBox='0 0 32 32'
